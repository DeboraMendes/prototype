...
/**
 * Responsável por criar o protótipo de pessoa do tipo incompleto.
 */
@Service
public class IncompletePersonPrototypeTypeService implements PersonPrototypeTypeService {
    ...
    public PersonPrototypeType type() {
        return PersonPrototypeType.INCOMPLETE;
    }
